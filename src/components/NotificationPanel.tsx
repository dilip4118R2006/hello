    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Panel */}
          <div className="absolute top-full right-10 mt-2 w-96 max-h-[600px] bg-gray-800/95 backdrop-blur-xl rounded-2xl border border-gray-700/50 shadow-2xl z-50 overflow-hidden">
            {/* Header */}
